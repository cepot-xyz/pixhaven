...
class AdjustmentEditor {
    ...
    loadImage(file) {
        ...
        reader.onload = (e) => {
            ...
            img.onload = () => {
                ...
                const maxHeight = this.canvasWrapper.offsetHeight - 80; // Account for buttons
    ...
    applyAdjustments() {
        ...
        for (let i = 0; i < data.length; i += 4) {
            ...
            // Sharpen (simplified)
            if (sharpen > 0) {
                // This is a basic sharpen, real implementation would need convolution
            ...
            configList.querySelectorAll('.preset-item-delete').forEach(btn => {
                btn.addEventListener('click', (e) => {
                    ...
                    if (confirm('Hapus konfigurasi ini?')) {
                        ...
                        this.showLoadConfigModal(); // Refresh modal
